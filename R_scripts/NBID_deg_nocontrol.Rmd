...
```{r}
D4_FA2.data.nocontrol = cbind(
  D4X_FA2_FRE.filtered,
  D4X_FA2_THA.filtered
)
group_D4_FA2_no_control = c(rep("FRESH", dim(D4X_FA2_FRE.filtered)[2]),
                            rep("FROZEN",
                            dim(D4X_FA2_THA.filtered)[2]))
```

```{r}
result = DEUsingNBID(D4_FA2.data.nocontrol, group_D4_FA2_no_control, ncore = 22)
```
...
saveRDS(res_combind, "../data/deg/D4_FA2_nocontrol.rds")
write.table(res_combind, "../data/deg/D4_FA2_nocontrol.tsv", sep = "\t")

```

```{r}
res_combind = readRDS("../data/deg/D4_FA2_nocontrol.rds")
...
res_combind = as.data.frame(res_combind)
res_combind = res_combind[order(res_combind$FDR), ]
saveRDS(res_combind, "../data/deg/D4_FA2_min500_nocontrol.rds")
write.table(res_combind, "../data/deg/D4_FA2_min500_nocontrol.tsv", sep = "\t")

```

```{r}
res_combind = readRDS("../data/deg/D4_FA2_min500_nocontrol.rds")
...
```{r}
D4_FA3.data.nocontrol = cbind(
  D4X_FA3_FRE.filtered,
  D4X_FA3_THA.filtered
)
group_D4_FA3_no_control = c(rep("FRESH", dim(D4X_FA3_FRE.filtered)[2]),
                            rep("FROZEN",
                            dim(D4X_FA3_THA.filtered)[2]))
```

```{r}
result = DEUsingNBID(D4_FA3.data.nocontrol, group_D4_FA3_no_control, ncore = 22)
```
...
res_combind = as.data.frame(res_combind)
res_combind = res_combind[order(res_combind$FDR), ]
saveRDS(res_combind, "../data/deg/D4_FA3_nocontrol.rds")
write.table(res_combind, "../data/deg/D4_FA3_nocontrol.tsv", sep = "\t")
```

```{r}
res_combind = readRDS("../data/deg/D4_FA3_nocontrol.rds")
...
res_combind = as.data.frame(res_combind)
res_combind = res_combind[order(res_combind$FDR), ]
saveRDS(res_combind, "../data/deg/D4_FA3_min500_nocontrol.rds")
write.table(res_combind, "../data/deg/D4_FA3_min500_nocontrol.tsv", sep = "\t")
```

```{r}
res_combind = readRDS("../data/deg/D4_FA3_min500_nocontrol.rds")
